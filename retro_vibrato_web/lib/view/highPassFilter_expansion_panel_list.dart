...
class HighPassFilterExpansionPanelList extends StatelessWidget {
  const HighPassFilterExpansionPanelList({super.key});

  @override
  Widget build(BuildContext context) {
    final settings = context.watch<HighPassFilterSettings>();
