...
class LowPassFilterExpansionPanelList extends StatelessWidget {
  const LowPassFilterExpansionPanelList({super.key});

  @override
  Widget build(BuildContext context) {
    final settings = context.watch<LowPassFilterSettings>();
